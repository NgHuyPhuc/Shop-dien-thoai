                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="prd_status" class="form-control">
                                    ...
                                    <option <?php echo $value['prd_status'] == 1 ? 'selected' : '' ?> value=1>Còn hàng</option>
                                    <option <?php echo $value['prd_status'] == 0 ? 'selected' : '' ?> value=0>Hết hàng</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input <?php echo $value['prd_featured'] == 1 ? 'checked':''?> name="prd_featured" type="checkbox" value=1>Nổi bật
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
